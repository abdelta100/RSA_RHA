...
def newmarkBetascract(applied_force: np.ndarray, t_arr: np.ndarray, wn: float, zeta: float, m=1, beta: float = 1 / 6,
                gamma_: float = 0.5) \
...
def newmarkBeta_GroundMotionscratch(ground_accel_arr: np.ndarray, t_arr: np.ndarray, wn: float, zeta: float, m=1, beta: float = 1 / 4,
